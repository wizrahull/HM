...
#     @detail=Detail.create(number: params[:number],city: params[:city],state: params, login_id: @login.id)
...
#     def detail_params
#       params.require(:detail).permit(:number, :city, :state)
#     end
# end
